...
knitr::write_bib(c(.packages(), 'bookdown', 'knitr', 'rmarkdown', 
                   "tidyverse","gplots","pheatmap"), 'packages.bib')
...
An up to date version of R [@R-base] and Rstudio [@rstudioteam2018]. These
materials were generated using R version 3.5.0.
