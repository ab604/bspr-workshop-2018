...
This shrinks the dataset from 7,702 proteins to 1,184 proteins, so we can see 
...
missing values with the mean observation for each protein.
...
```{r max-normalisation, echo=FALSE, cache=TRUE}
...
```{r compare-normalisation, fig.cap='(ref:compare-qnorm)', out.width= '80%', fig.asp= 0.5, fig.align='center', echo = FALSE, cache=TRUE}
